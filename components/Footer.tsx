const services = ["Custom Software Development", "Web Application Development", "Website Design & Development", "SaaS Platform Development", "Payment Integration (M-Pesa / Card)", "IT Consultancy & Strategy"];
  ...
  return (
    <footer className="bg-slate-950 text-slate-300 pt-12 pb-8 mt-16">
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-3 gap-10">
        <div>
          <p className="text-xl font-bold text-white mb-1">Dantechdevs <span className="text-red-500">Developers</span></p>
        ...
        <div>
          ...
          <p className="text-sm mb-1">Email: <span className="text-white font-medium">support@dantechdevs.co.ke</span></p>
          <p className="text-sm mb-1">Phone: <span className="text-white font-medium">+254 712 328150 / +254 728 328150</span></p>
